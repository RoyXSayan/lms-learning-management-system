...
const SearchPage = () => {
  ...
  const { data: rawData, isLoading } = useGetSearchCourseQuery({
  searchQuery: query
});

// Step 1: Partial category match filter
...
const sortedCourses = [...filteredCourses].sort((a, b) => {
  if (sortByPrice === "low") return a.coursePrice - b.coursePrice;
  if (sortByPrice === "high") return b.coursePrice - a.coursePrice;
  return 0;
});
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="flex-1">
          {isLoading ? (
            ...
            sortedCourses.map((course) => <SearchResult key={course._id} course={course}/>)
          )}
        </div>
      </div>
    </div>
